...
class CurrencySeeder extends Seeder
{
    ...
    public function run()
    {
        try {
            ...
            $aclService->createPermission('currency', 'Devizák kezelése', 'admin');
        ...
        $currencies = [
            ...
            ['code' => 'EUR', 'name' => 'Euro', 'symbol' => '€', 'is_enabled' => true],
            ...
            ['code' => 'HUF', 'name' => 'Forint', 'symbol' => 'Ft', 'is_enabled' => true, 'decimals' => 0, 'is_default' => true, 'decimal_separator' => ',', 'thousands_separator' => '.'],
            ...
            ['code' => 'USD', 'name' => 'US Dollar', 'symbol' => '$', 'is_enabled' => true, 'is_symbol_first' => true],
